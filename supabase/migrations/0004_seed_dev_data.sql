...
-- Using development bcrypt hash. Strictly for local environment usage.
-- ----------------------------------------------------------------------------
...
VALUES
    -- Workspace 1 Users
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9801', 'owner@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Paul K.", "role": "owner"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9802', 'g.sterling@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Gregory Sterling", "role": "executive"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9803', 'executive@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Sarah Lansky", "role": "executive"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9804', 'e.davis@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Emily Davis", "role": "executive"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9805', 'manager@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Marcus Dupond", "role": "manager"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9806', 'j.smith@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Jane Smith", "role": "manager"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9807', 'rep@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Tom Collins", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9808', 'd.schrute@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Dwight Schrute", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9809', 'j.doe@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "John Doe", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9810', 'a.cooper@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Alice Cooper", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9811', 'b.martin@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Bob Martin", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),
    -- Charlie Brown is seeded as a test case for RLS exclusion (Revoked profile)
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9812', 'c.brown@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Charlie Brown", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid),

    -- Workspace 2 Users
    ('8b1933c0-0f0e-4361-b472-3c8cfa2b9999', 'eve.tenant@whitebox.com', '$2a$10$U.yP0zM2Q7K3t.GgL2qL0.m3F07oU1N0S/4zYgO/q1rG/0Z/Gg3vS', now(), '{"name": "Eve Tenant", "role": "rep"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, false, 'authenticated', 'authenticated', false, false, now(), now(), '00000000-0000-0000-0000-000000000000'::uuid)
ON CONFLICT (id) DO NOTHING;
